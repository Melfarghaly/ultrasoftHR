				...
				<div class="row mt-15">
					<div class="col-md-12">
						<div class="form-group">
		            		...
		            		{!! Form::select('status_id', $status_dropdown['statuses'], $job_sheet->status_id, ['class' => 'form-control ', 'required', 'style' => 'width:100%', 'placeholder' => __('messages.please_select'), 'required', 'id' => 'status_id_modal'], $status_dropdown['template']); !!}
						</div>
					</div>
				</div>
				<div class="row">
