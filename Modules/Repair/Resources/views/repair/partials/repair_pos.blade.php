...
<div class="row">
	...
	<div class="col-sm-4">
		<div class="form-group">
			...
			<div class="input-group">
			    {!! Form::select('repair_model_id', $view_data['device_models'], !empty($repair['repair_model_id']) ? $repair['repair_model_id'] : null, ['device_model_id'=>'device_model_id','class' => 'form-control select2', 'placeholder' => __('messages.please_select')]); !!}
