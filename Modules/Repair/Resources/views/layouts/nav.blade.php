        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    @can('repair.create')
                        <li @if(request()->segment(2) == 'repair' && request()->segment(3) == 'create') class="active" @endif><a href="/pos/create'?sub_type=repair">@lang('repair::lang.add_invoice')</a></li>
                    @endcan

                    @if(auth()->user()->can('brand.view') || auth()->user()->can('brand.create'))
                        <li @if(request()->segment(1) == 'brands') class="active" @endif><a href="/brnads">@lang('brand.brands')</a></li>
                    @endif
