        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li @if(request()->get('type') == 'hrm_department') class="active" @endif><a href="/taxonomies?type=hrm_department">@lang('essentials::lang.departments')</a></li>
                    @endcan
                    
                    @can('essentials.crud_designation')
                    <li @if(request()->get('type') == 'hrm_designation') class="active" @endif><a href="/taxonomies?type=hrm_designation">@lang('essentials::lang.designations')</a></li>
                    @endcan
