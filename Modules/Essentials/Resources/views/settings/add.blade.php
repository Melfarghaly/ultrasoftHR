...
<section class="content">
            ...
            <div class="col-xs-12 pos-tab-container">
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 pos-tab-menu">
                    <div class="list-group">
                        ...
                        <a href="#" class="list-group-item text-center">انواع الاجتماعات</a>
                ...
                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 pos-tab">
                    @include('essentials::settings.partials.meeting_status')
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            {{Form::submit(__('messages.update'), ['class'=>"btn btn-danger",'onClick'=>"sub_form();"])}}
            </div>
        </div>
    </div>
    {!! Form::close() !!}
...
<script type="text/javascript">
    $(document).ready( function () {
     ...
     function sub_form(){
        $('#essentials_settings_form').submit();
    }
</script>
@endsection