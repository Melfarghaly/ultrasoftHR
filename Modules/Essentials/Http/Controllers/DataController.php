...
class DataController extends Controller
{
    ...
    public function user_permissions()
    {
        return [
            ...
            [
                'value' => 'edit_essentials_settings',
                'label' => __('essentials::lang.edit_essentials_settings'),
                'default' => false
            ],
            [
                'value' => 'essentials.create_payroll',
                'label' => __('essentials::lang.create_payroll'),
                'default' => false
            ],
             [
                'value' => 'essentials.edit_payroll',
                'label' => __('تعديل payroll'),
                'default' => false
            ],
            [
                'value' => 'essentials.delete_payroll',
                'label' => __('حذف payroll'),
                'default' => false
            ],
            [
                'value' => 'essentials.add_payment',
                'label' => __('اضافة دفعة '),
                'default' => false
            ],
    ...
    */
    ...
    {   
        ...
        if ($data['event'] = 'user_saved') {
            ...
            $user->fixed_deductions=!empty($payrolls[0]) ? json_encode($payrolls[0]) : NULL;
            $user->save();
