...
<section class="content no-print">
	...
	@endcomponent
	<div class="modal fade contact_login_modal" tabindex="0" role="dialog" aria-labelledby="gridSystemModalLabel"></div>
</section>
@endsection
@section('javascript')
	<script src="{{ asset('modules/crm/js/crm.js?v=' . $asset_v) }}"></script>
	<script>
$('.contact_login_modal').on('shown.bs.modal', function () {
        debugger;
    $('.select2').select2({
        // Add any necessary options or configurations here
         dropdownParent: $('.contact_login_modal')
    });
