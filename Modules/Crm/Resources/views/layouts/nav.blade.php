            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    @can('crm.access_sources')
                        <li @if(request()->get('type') == 'source') class="active" @endif><a href="taxonomies?type=source">@lang('crm::lang.sources')</a></li>
                    @endcan
                    @can('crm.access_life_stage')
                        <li @if(request()->get('type') == 'life_stage') class="active" @endif><a href="taxonomies?type=life_stage">@lang('crm::lang.life_stage')</a></li>
                    @endcan
