...
@section('javascript')
	...
	setInterval(function(){
             //$('.open').toggleClass("open_waiting");
              $('.openEffect').parent('a').parent('td').parent('tr').toggleClass("open_waiting");

              $('.completed').parent('a').parent('td').parent('tr').addClass("completed_effect");
               $('.lateEffect').parent('a').parent('td').parent('tr').toggleClass("lated_effect");
                console.log('done');
            }, 1000);
