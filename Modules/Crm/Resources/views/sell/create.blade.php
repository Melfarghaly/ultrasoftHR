...
@php
	...
	$this_customer=[];
	$this_customer[$walk_in_customer['id']]=$walk_in_customer['name'];
	$is_reservation=true;
@endphp
...
@if(!empty($pos_settings['allow_overselling']))
	<input type="hidden" id="is_overselling_allowed" name="is_overselling_allowed" value="1">
@endif
						...
						<div class="col-sm-4">
							<div class="form-group">
								<div class="input-group">
									...
									{!! Form::select('price_group', $price_groups,  $walk_in_customer['price_group_id'], ['class' => 'form-control ', 'id' => 'price_group']); !!}
									<span class="input-group-addon">
					...
					<div class="form-group">
						...
						<div class="input-group">
							...
							{!! Form::select('contact_id', 
								$this_customer, $walk_in_customer['id'] , ['class' => 'form-control mousetrap', 'id' => 'customer_id2', 'placeholder' => 'Enter Customer name / phone', '']); !!}
						</div>
					</div>
					<small>
					<strong>
			 ...
			 <div class="col-md-4">
				        <div class="form-group">
				            @php
				                ...
				                $companies=\DB::table('shipping_company')->where('business_id',$business_id)->get();
				            @endphp
				            {!! Form::label('shipping_details_modal', __('شركة الشحن') . ':' ) !!}
				          <select name="shipping_company_id_modal" class="form-control" id="shipping_company_id_modal">
