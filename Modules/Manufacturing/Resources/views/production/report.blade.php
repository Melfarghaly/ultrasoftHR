...
<section class="content">
    ...
    <div class="row no-print">
        <div class="col-md-3">
            <a href="/reports/stock-report'?only_mfg=true" class="btn btn-info btn-flat btn-block">@lang('report.stock_report')</a>
        </div>
        ...
        <div class="col-md-3">
            <a href="/reports/stock-expiry-report?only_mfg=true" class="btn btn-warning btn-flat btn-block">@lang('report.stock_expiry_report')</a>
        </div>
        @endif
        <div class="col-md-3">
            <a href="/reports/items-report?only_mfg=true" class="btn btn-danger btn-flat btn-block">@lang('lang_v1.items_report')</a>
        </div>
    </div>
    <br>
    <div class="row no-print">
