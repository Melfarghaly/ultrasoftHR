<div class="pos-tab-content active">
    ...
    <div class="col-sm-4">
        <div class="form-group">
            {!! Form::label('start_date', __('business.fy_start_date') . ':') !!}
            <div class="input-group">
                <span class="input-group-addon">
                    <i class="fa fa-calendar"></i>
                </span>
                
                {!! Form::text('fy_start_date', !empty($business->fy_start_date) ?   @format_date($business->fy_start_date) : null, ['class' => 'form-control start-date-picker','placeholder' => __('business.start_date')]); !!}
            </div>
        </div>
    </div>
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('fy_end_date', __('business.fy_end_date') . ':') !!}
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-calendar"></i>
                        </span>
                        {!! Form::text('fy_end_date',!empty($business->fy_end_date) ? @format_date($business->fy_end_date) : null, ['class'=> 'form-control end-date-picker','placeholder' => __('business.fy_end_date')]); !!}
                </div>
            </div>
        </div>
    </div>
