...
<div class="row invoice-info">
	...
	<div class="col-md-6 invoice-col width-50">
		...
		<div class="text-right font-23">
			...
			{{$receipt_details->invoice_no}}
            <span class="pull-left">Invoice no</span>
		</div>
...
<div class="word-wrap">
			...
			@if(!empty($receipt_details->customer_label))
				<b class="pull-right">{{ $receipt_details->customer_label }}</b>
			@endif
...
<div class="row ">
	<div class="col-xs-12">
		...
		<table class="table table-bordered table-no-top-cell-border table-slim">
			<thead>
				<tr style="background-color: #dfdfdf !important; color:black !important; font-size: 15px !important" class="table-no-side-cell-border table-no-top-cell-border text-center">
					<td style="background-color: #dfdfdf !important; color:black !important;width: 3% !important">#</td>
					...
					@if($receipt_details->show_cat_code != 1)
						...
						@endphp
					@endif
					<td style="background-color: #dfdfdf !important; color:black !important; width: {{$p_width}}% !important">
						{{$receipt_details->table_product_label}}
					</td>

					@if($receipt_details->show_cat_code == 1)
						<td style="background-color: #dfdfdf !important; color:black !important; width: 10% !important;">{{$receipt_details->cat_code_label}}</td>
					@endif
					
					<td style="background-color: #dfdfdf !important; color:black !important;width: 10% !important;">
					...
					<td style="background-color: #dfdfdf !important; color:black !important;width: 8% !important;">
			...
			<tbody>
				@foreach($receipt_details->lines as $line)
					<tr>
						...
						<td class="text-right">
							{{$line['unit_price_before_discount_uf'] *  $line['quantity_uf']}} 
						</td>
						<td class="text-right">
	...
	<div class="col-md-6 invoice-col width-50">
		<table class="table-no-side-cell-border table-no-top-cell-border width-100 table-slim">
			<tbody>
				...
				<!-- Total -->
				<tr>
					<th style="background-color: #dfdfdf !important; color:black !important" class="font-23 padding-10">
						{!! $receipt_details->total_label !!}
					</th>
					<td class="text-right font-23 padding-10" style="background-color: #dfdfdf !important; color:black !important">
