...
<style>
    @font-face {
        ...
        .cont {
            ...
            background-image: linear-gradient(to right, #29acff, #1b75bb);
            color: white;
            display: block;
            height: 140px;
            text-align: center;
            ...
            border-bottom: 9px solid #9775d3;
        }
        ...
        <div class="tw-px-5 tw-pt-3">
            ...
            @if (auth()->user()->can('dashboard.data'))
                @if ($is_admin)
                    ...
                    <div class="tw-grid tw-grid-cols-1 tw-gap-4 tw-mt-6 sm:tw-grid-cols-2 xl:tw-grid-cols-4 sm:tw-gap-5 hide">
            ...
            @if ($is_admin)
                <div class="tw-relative">
                    ...
                    <div class="tw-px-5 tw-isolate">
                        <div
                            class="tw-grid tw-grid-cols-1 tw-gap-4 tw-mt-4 sm:tw-mt-6 sm:tw-grid-cols-2 xl:tw-grid-cols-4 sm:tw-gap-5 hide">
                            <div
    ...
    <div class="row">
                        <div class="box ">
                            ...
                            <div style="background-color: white;
                                        ...
                                        border-radius: 10px 10px 0px 0px;" bis_skin_checked="1">
                                <div class="row" bis_skin_checked="1">
                                    <div class="col-md-2 col-sm-4 col-xs-6 col-6" bis_skin_checked="1">
                                    ...
                                    <div class="col-md-2 col-sm-4 col-xs-6 col-6" bis_skin_checked="1">
                                        <a href="products/create" class="cont">
                                    ...
                                    <div class="col-md-2 col-sm-4 col-xs-6 col-6" bis_skin_checked="1">
                                        <a href="/products" class="cont">
                                            <h2><i class="fas fa-th-large"></i></h2>
                                            <h3>قائمة المنتجات</h3>
                                        </a>
                                    </div>

                                    <div class="col-md-2 col-sm-4 col-xs-6 col-6" bis_skin_checked="1">
                                        <a href="purchases/create" class="cont">
                                ...
                                <div class="row" bis_skin_checked="1">
                                    ...
                                    <div class="col-md-2 col-sm-4 col-xs-6 col-6" bis_skin_checked="1">
                                    <a href="/modules/orders" class="cont">
                                        <h2><i class="fa fa-business-time"></i></h2>
                                        <h3> طاقم الخدمة </h3>
                                        </a>
                                    </div>

                                    <div class="col-md-2 col-sm-4 col-xs-6 col-6" bis_skin_checked="1">
                                        <a href="business-location" class="cont">
                                ...
                                <div class="row" bis_skin_checked="1">
                                    ...
                                    <div class="col-md-2 col-sm-4 col-xs-6 col-6" bis_skin_checked="1">
                                        <a href="reports/trending-products" class="cont">
                                            <h2><i class="fas fa-chart-line"></i></h2>
                                            <h3>الأكثــر مبيعاً</h3>
                                        </a>
                                    </div>
                                    <div class="col-md-2 col-sm-4 col-xs-6 col-6" bis_skin_checked="1">
                                        <a href="discount" class="cont">
                                            <h2><i class="fas fa-percent"></i></h2>
                                            <h3>خصـــومـات</h3>
                                        </a>
                                    </div>
                                <div class="col-md-2 col-sm-4 col-xs-6 col-6" bis_skin_checked="1">
                                        <a href="/bookings" class="cont">
                                            <h2><i class="fas fa-calendar-alt"></i></h2>
                                            <h3> الحجوزات</h3>
                                        </a>
                                    </div>
                                    <div class="col-md-2 col-sm-4 col-xs-6 col-6" bis_skin_checked="1">
                                        <a href="/invoice-schemes" class="cont">
                                            <h2><i class="fas fa-print"></i></h2>
                                            <h3>إعدادات الفاتورة</h3>
                                        </a>
                                    </div>
                                    <div class="col-md-2 col-sm-4 col-xs-6 col-6" bis_skin_checked="1">
                                        <a href="/business/settings" class="cont">
