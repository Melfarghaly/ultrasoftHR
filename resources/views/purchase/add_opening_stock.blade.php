...
<section class="content">
	...
	{!! Form::open(['url' => action([\App\Http\Controllers\ImportOpeningStockController::class, 'storeOpeningStock']), 'method' => 'post', 'id' => 'add_purchase_form', 'files' => true ]) !!}
		...
		<div class="row">
			...
			<div class="col-sm-3 @if(!empty($default_purchase_status)) hide @endif hide">
				<div class="form-group">
					...
					{!! Form::select('status', $orderStatuses, $default_purchase_status, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select')]); !!}
				</div>
			</div>			
