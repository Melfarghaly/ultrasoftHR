...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/contacts/opening-balances', [ContactController::class, 'indexOpeningBalance']);
    Route::get('/contacts/getOpeningBalance',[ContactController::class , 'getOpeningBalance'])->name('getOpeningBalance');
    Route::post('/opening_balance/update', [ContactController::class, 'updateAllOpeningBalance'])->name('updateAllOpeningBalance');
    ...
    Route::get('/contacts/opening_balance/{contact_id}', [ContactController::class, 'editOpeningBalance']);
    Route::put('/contacts/{contact_id}/opening_balance', [ContactController::class, 'updateOpeningBalance']);
